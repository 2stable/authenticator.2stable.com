...
title: How to enable 2FA for Epic Games
description: A Step-by-Step guide how to setup two-factor authentication for Epic Games
author: Kevin Archer
twitter: IM_Kevin_Archer
permalink: /2fa-guides/epic-games/
    ...
    <div class="text-center">
        ...
        <div class="px-md-5 px-2 pt-5">
            <div class="callout callout-warning text-start">
                <strong>Note:</strong> If you haven't set up two-factor authentication or you don't have access to your Epic Games account, please contact Epic Games support directly.
            </div>
        </div>
    </div>
    {% endif %}
