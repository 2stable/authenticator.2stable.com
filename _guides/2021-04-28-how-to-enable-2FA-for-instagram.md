    ...
    <div class="text-center">
        ...
        <div class="px-md-5 px-2 pt-5">
            <div class="callout callout-warning text-start">
                <strong>Note:</strong> If you haven't set up two-factor authentication or you don't have access to your Instagram account, please contact Instagram support directly.
            </div>
        </div>
    </div>
    {% endif %}
