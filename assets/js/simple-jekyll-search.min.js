...
! function() {
  ...
  ! function(t) {
      let i = {
              ...
              // searchResultTemplate: '<div><a href="{url}"><h6 class="m-0">{name}</h6></a><span>{host}</span></div>',
              searchResultTemplate: '<tbody><tr class="align-middle"><th class="text-start py-3"><a href="{url}" class="d-flex align-items-center text-dark" target="_blank"><img class="rounded me-2" src="/assets/img/2fa-services/Icons/{host}.png" width="32" alt="GitHub logo"><span class="fw-normal">{name}</span></a></th><td class="align-items-center"><a href="{doc}" target="_blank">Read</a></td><td>{hasU2f}<i class="text-success h3 bi bi-check"></i></td><td><i class="text-success h3 bi bi-check"></i></td></tr></tbody>',
              templateMiddleware: Function.prototype,
              sortMiddleware: function() {
                  return 0
              },
              noResultsText: '<tr class="d-flex"><td class="border-0">No results found</td></tr>',
              limit: 10,
              fuzzy: !1,
              debounceTime: null,
              exclude: []
